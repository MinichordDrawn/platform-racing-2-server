...
setpriv --reuid=pr2obs --regid=pr2obs --clear-groups php -d auto_prepend_file= /pr2/observers/policy/run.php &
...
exec setpriv --reuid=www-data --regid=www-data --clear-groups php /pr2/policy_server/run_policy.php
